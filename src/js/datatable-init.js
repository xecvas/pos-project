...
export function initDataTable() {
    ...
    window.menuTable = $("#mymenu").DataTable({
      ...
      columns: [
        ...
        { data: "harga", title: "Price", render: (value) => `Rp. ${value.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")}`, width: "200px" },
      ...
      dom: "<'row'<'col-sm-6'l><'col-sm-6'f>>" + "<'row'<'col-sm-12't>>" + "<'row'<'col-sm-4'i><'col-sm-4 d-flex justify-content-center'p><'col-sm-4'>>",
      language: {
        search: "Search:",
